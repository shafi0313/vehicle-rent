...
@section('content')
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
                ...
                <div class="">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0 align-items-center">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Vehicle Category</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-between index_title">
                <h6 class="mb-0">Vehicle Category List</h6>
    ...
    @can('vehicle-category-add')
        @include('dashboard.vehicle_category.create')
    @endcan
    @push('custom_scripts')
        ...
        <script>
            $(function() {
                $('#data_table').DataTable({
                    ...
                    responsive: true,
                    scrollY: 400,
                    ajax: "{{ route('admin.vehicle-category.index') }}",
                    columns: [
                        // {
                        //     data: 'check',
                        //     name: 'check',
